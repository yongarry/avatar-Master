...
{
    public class VRPublisher_3x4matrix : UnityPublisher<MessageTypes.tocabi_msgs.matrix_3_4>
    {
        public enum EIndex
        {
            None = -1,
        ...
        public EIndex index;
        private MessageTypes.tocabi_msgs.matrix_3_4 message;
        // private MessageTypes.Std.Bool status;
        ...
        {
            message = new MessageTypes.tocabi_msgs.matrix_3_4()
            {
